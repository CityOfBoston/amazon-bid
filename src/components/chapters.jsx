            ...
            <div className="g">
              <div className="g--6">
                <div className="ch-t ch-c">
                  ...
                  <div className="t--info">Innovation is embedded in Boston’s DNA. From Boston’s world class researchers, engineers, and scientists to our motivation for addressing societal growth, Boston is a city with a passion for creativity, transformation, and invention.</div>
            ...
            <div className="g">
              <div className="g--6">
                <div className="ch-t ch-c">
                  ...
                  <hr className="hr hr--sq" />
                  <p className="t--s500 lh-300">Boston would be thrilled to welcome Amazon’s second North American headquarters to our city. As part of our response to Amazon’s Request for Proposal, this chapter provides information requested.</p>
                </div>
              </div>
              <div className="g--6">
                <div className="ch-c">
