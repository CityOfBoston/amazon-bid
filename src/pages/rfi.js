            ...
            <div className="g">
              <div className="g--8">
                <div className="t--intro">
                  ...
                  Take a look below to learn more about what we have to offer.
                </div>
              </div>
        ...
        <div className="b b--fw">
          <div className="hro hro--books">
            <div className="hro-c">
              ...
              <div
                className="hro-st hro-st--l"
                style={{ marginBottom: 25, color: "rgb(255,255,255)" }}
              >
                &nbsp;
              </div>
        ...
        <div className="b b--g b--fw">
          <div className="b-c">
            ...
            <div className="g m-b500">
              <div className="g--8">
                <div className="t--intro">
                  Somerville’s response to the RFI questions.
                </div>
              </div>
              <div className="g--4 ta-r--large">
                <a
                  href="https://d279ml9s9jjbhy.cloudfront.net/somerville/somerville.zip"
                  className="btn"
                  download
                >
                  Download All
            ...
            <div className="g">
              <a
                href="https://d279ml9s9jjbhy.cloudfront.net/somerville/MA_Boston_Somerville Orange Line_Talent.pdf"
              ...
              <a
                href="https://d279ml9s9jjbhy.cloudfront.net/somerville/MA_Boston_Somerville Orange Line_Growth.pdf"
                className="cd m-t500 g--12"
                download
              >
                <img
              ...
              <a
                href="https://d279ml9s9jjbhy.cloudfront.net/somerville/real_estate.zip"
                className="cd m-t500 g--12"
                download
              >
                <img
              ...
              <a
                href="https://d279ml9s9jjbhy.cloudfront.net/somerville/MA_Boston_Somerville Orange Line_Incentives.pdf"
                className="cd m-t500 g--12"
                download
              >
                <img
              ...
              <a
                href="https://d279ml9s9jjbhy.cloudfront.net/somerville/MA_Boston_Somerville Orange Line_Taxes and Tax Policy.pdf "
                className="cd m-t500 g--12"
                download
              >
                <img
